 ...
 */
final class Version20230405145400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE achat ADD date_achat DATETIME NOT NULL, ADD quantite INT NOT NULL, ADD status VARCHAR(255) NOT NULL');
